...
pub(super) fn initial_view() -> View {
        ...
        .map(|w| w[1].as_str())
    {
        ...
        Some("recovery-plans") => View::RecoveryPlans,
        Some("recovery-background") => View::RecoveryDaemon,
        Some("recovery-extensions") => View::RecoveryExtensions,
        Some("changes") => View::ChangeHistory,
        Some("lab") => View::TestLab,
        Some("diagnostics") => View::Intelligence,
        Some("release") => View::Release,
